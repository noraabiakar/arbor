...
throw arbor_exception("CUDA memory:: "+std::string(__func__)+" "+std::string((msg))+": "+device_error_string(error));
...
#define NOGPU \
LOG_ERROR("memory:: "+std::string(__func__)+"(): no CUDA/HIP support")
