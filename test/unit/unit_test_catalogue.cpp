...
#include "mechanisms/test0_kin_dual_compartment.hpp"
...
#include "mechanisms/test5_kin_diff.hpp"
...
mechanism_catalogue make_unit_test_catalogue() {
    ...
    ADD_MECH(cat, test0_kin_dual_compartment)
